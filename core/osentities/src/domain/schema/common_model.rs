...
impl CommonModel {
    ...
    pub async fn fetch_all_enum_references(
        ...
        cm_store: MongoStore<CommonModel>,
        ce_store: MongoStore<CommonEnum>,
    ) -> Result<Vec<CommonEnum>, PicaError> {
    ...
    ) -> Result<(HashMap<String, CommonModel>, HashSet<String>), PicaError> {
...
impl Expandable {
    pub async fn expand(&self, store: MongoStore<CommonModel>) -> Result<Self, PicaError> {
        Ok(match self {
            Expandable::Unexpanded { reference } => {
